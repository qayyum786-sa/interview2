// app/custom-app-development/page.jsx
"use client";
  ...
  return (
    <div className="w-full antialiased text-slate-800">
      ...
      <header
        ...
        style={{
          backgroundImage:
            "linear-gradient(135deg, rgba(6,11,34,0.6), rgba(11,102,195,0.25)), url('/appdev-hero.jpg')",
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          <p className="mt-4 text-lg sm:text-xl text-white/90 max-w-2xl">
            End-to-end mobile & web applications built for performance, usability and scale — tailored to your product vision.
          </p>

          <div className="mt-6 flex flex-wrap gap-3">
            <a href="#platforms">
              <Button label="Platforms & Tech" className="bg-[#0b66c3] hover:bg-[#095aa3] text-white" />
            </a>
            <a href="#packages">
      ...
      <main className="max-w-6xl mx-auto px-6 -mt-16 space-y-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-3 mb-4">
                ...
                <span className="text-slate-500 font-medium uppercase text-xs tracking-wider">Product</span>
              </div>

              <h2 className="text-2xl md:text-3xl font-bold mb-3">Overview</h2>
              <p className="text-lg text-slate-700 leading-relaxed mb-4">
                We design and build custom web and mobile applications — from MVPs to enterprise-grade platforms — focusing on fast time-to-value, secure architecture and delightful UX.
              </p>
              ...
              <ul className="grid sm:grid-cols-2 gap-3 mt-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-slate-600">MVPs & product validation</span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-slate-600">Scalable backend & APIs</span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-slate-600">Cross-platform mobile apps</span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-slate-600">CI/CD, testing & observability</span>
                </li>
              </ul>
            </div>
            ...
            <div className="rounded-xl overflow-hidden shadow-md transform transition-all duration-400 hover:scale-[1.02]">
              <Image
                src="/appdev-illustration.jpg"
                width={900}
                height={600}
                alt="Custom app development illustration"
        ...
        <section id="platforms" className="space-y-6">
          <h3 className="text-2xl font-bold">Platforms & Tech</h3>
          <p className="text-slate-600">We pick the right technology for the product — modern, maintainable stacks that scale.</p>

          <div className="grid md:grid-cols-3 gap-6">
            {[
              { title: "Web Apps", text: "React / Next.js, SSR/SSG, PWAs and accessible UIs." },
              { title: "Mobile Apps", text: "React Native / Flutter — native performance with shared code where possible." },
              { title: "Backend & APIs", text: "Node.js, Python, or Java + REST / GraphQL, microservices & serverless options." },
              { title: "Data & Integrations", text: "Third-party integrations, webhooks, ETL and analytics pipelines." },
              { title: "DevOps & Security", text: "CI/CD, containerization, monitoring, and secure deployments." },
              { title: "Testing & QA", text: "Unit/integration tests, E2E, and automated regression suites." },
            ].map((p, i) => (
              <div key={i} className="rounded-xl overflow-hidden group bg-white shadow hover:shadow-2xl transition-all duration-300">
                <div className="p-6">
                  <div className="inline-flex items-center justify-center rounded-lg w-12 h-12 mb-4 bg-gradient-to-br from-[#0b66c3] to-[#06b6d4] text-white shadow-md">
                    <span className="font-semibold text-sm">{p.title.split(" ")[0][0]}</span>
                  </div>
                  <h4 className="font-semibold mb-2">{p.title}</h4>
                  <p className="text-sm text-slate-600 mb-4">{p.text}</p>
        ...
        <section className="space-y-6">
          <h3 className="text-2xl font-bold">Delivery Process</h3>
          <p className="text-slate-600">Transparent delivery from discovery to maintenance.</p>

          <div className="grid md:grid-cols-4 gap-6">
            {[
              { title: "Discover", text: "User research, product strategy & requirements", color: "from-[#7c3aed] to-[#06b6d4]" },
              { title: "Design", text: "UX, UI and prototypes for rapid validation", color: "from-[#f97316] to-[#f43f5e]" },
              { title: "Build", text: "Iterative sprints, APIs & automated tests", color: "from-[#06b6d4] to-[#0ea5a4]" },
              { title: "Operate", text: "Monitoring, maintenance & continuous improvement", color: "from-[#0ea5a4] to-[#6366f1]" },
            ].map((s, idx) => (
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { title: "Offline-first Support", text: "Apps that continue to function with intermittent connectivity." },
              { title: "Role-based Access", text: "Granular permissions for users and admins." },
              { title: "Realtime Sync", text: "WebSockets / push updates for live experiences." },
            ].map((f,i)=>(
              <div key={i} className="relative rounded-xl overflow-hidden shadow hover:shadow-2xl transition-all duration-300 group">
                ...
                <div className="p-4 bg-slate-50">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-sm text-slate-700 font-medium group-hover:text-[#0b66c3] transition-colors">Explore →</div>
                  </div>
                </div>
              </div>
            ))}
        ...
        <section id="packages">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { name: "MVP", price: "₹1.5L", items: ["Core flows", "Prototype & MVP", "2 months support"] },
              { name: "Growth", price: "₹4L", items: ["Full product", "Integrations", "6 months support"] },
              { name: "Scale", price: "Custom", items: ["Dedicated team", "Performance ops", "SLAs"] },
            ].map((p,i)=>(
        ...
        <section className="rounded-2xl p-8 text-center bg-gradient-to-r from-[#f0f9ff] via-white to-[#eef2ff] shadow-lg">
          <h3 className="text-2xl font-bold mb-2">Ready to build your custom app?</h3>
          <p className="text-slate-600 mb-6 max-w-2xl mx-auto">
            Book a free discovery session — we’ll evaluate scope, timelines and recommend a pragmatic roadmap.
          </p>
